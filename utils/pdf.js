...
function generateHeader(doc) {
    doc
        ...
        .text("Alexandria", 200, 80, { align: "right" })
        .moveDown();
}
...
function generateCustomerInformation(doc, invoice) {
    ...
    doc
        ...
        .text(
            formatCurrency(invoice.totalPrice * 100),
            150,
...
function generateInvoiceTable(doc, invoice) {
    ...
    for (i = 0; i < invoice.items.length; i++) {
        ...
        generateTableRow(
            ...
            item.quantity,
            formatCurrency(item.allPrice * 100)
        );
    ...
    const paidToDatePosition =invoiceTableTop + (i + 1) * 50 ;
    generateTableRow(
        doc,
        paidToDatePosition,
        "",
